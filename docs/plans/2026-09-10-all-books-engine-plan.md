...
- 保留 23 本、4,056 张图片、2,082 段音频和 1,394 个训练页的数据范围。
...
- [ ] 在 `test-book-practice.cjs` 写入 23 本预期训练数：`100,96,96,96,54,12,67,14,85,64,56,39,99,99,90,90,93,24,24,24,24,24,24`，并断言总数 1,394。
